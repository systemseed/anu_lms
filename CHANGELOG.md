...
## [Unreleased]
 - Adds ability to sort order of courses in the same category.
 - Adds locking of courses based on the order within their category.

## [2.3.8]
 - Adds a progress bar for courses with linear progress enabled.
 - Adds finish button at the end of courses without a quiz with customizable text and path.
